...
You can preview the default themes in the [appropriate folder](https://github.com/jamestomasino/stutter/tree/master/Screenshots). If you want to add your own, the easiest, it requires only three additions to the code-base:
